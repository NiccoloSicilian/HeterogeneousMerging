...
MNIST_STD_MODEL = "/leonardo_scratch/fast/IscrC_eff-SAM2/HeterogeneousMerging/models/standard_large_model_gelu.pth"#"/kaggle/working/models/standard_model_relu.pth"#"/kaggle/working/models/standard_model_relu.pth"
MNIST_WIDE_MODEL = "/leonardo_scratch/fast/IscrC_eff-SAM2/HeterogeneousMerging/models/wide_large_model_gelu.pth"#"/kaggle/working/models/wide_model_relu.pth"
FMNIST_STD_MODEL = "/leonardo_scratch/fast/IscrC_eff-SAM2/HeterogeneousMerging/models/standard_large_finetuned_gelu.pth"#/kaggle/working/models/standard_finetuned_relu.pth"
FMNIST_WIDE_MODEL = "/leonardo_scratch/fast/IscrC_eff-SAM2/HeterogeneousMerging/models/wide_large_finetuned_gelu.pth"#"/kaggle/working/models/wide_finetuned_relu.pth"
USE_RELU = True
...
EXTRACT_ACTIVATION = {                                                                                                                                                                                                                               
  ...
  'to_extract': [ 
      {'using': 'standard',    'method': method_gvendi_interpolated, 'params': {**gvendi_params, 'interp_number': 100, 'seed': 42}, 'filename': 'standard_fashion_interp'},
      {'using': 'wide',        'method': method_gvendi_interpolated, 'params': {**gvendi_params, 'interp_number': 100, 'seed': 42}, 'filename': 'wide_fashion_interp'},
...
COMPUTE_ORTHO_MAP = {                                                                                                                                                                                                                                
      ...
      'save_dir': '/leonardo_scratch/fast/IscrC_eff-SAM2/HeterogeneousMerging',                                                                                                                                                                                                                 
      'act_dir': '/leonardo_scratch/fast/IscrC_eff-SAM2/HeterogeneousMerging/activations',                                                                                                                                                                                                        
      'to_compute': [
          {'source': 'wide_fashion_gvendi12.1_sub0',   'target': 'standard_fashion_gvendi12.1_sub0',   'name': 'wide_to_std_gvendi_fashion_12.1_sub0',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi13.6_sub1',   'target': 'standard_fashion_gvendi13.6_sub1',   'name': 'wide_to_std_gvendi_fashion_13.6_sub1',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi14.5_sub2',   'target': 'standard_fashion_gvendi14.5_sub2',   'name': 'wide_to_std_gvendi_fashion_14.5_sub2',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi14.0_sub3',   'target': 'standard_fashion_gvendi14.0_sub3',   'name': 'wide_to_std_gvendi_fashion_14.0_sub3',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi14.3_sub4',   'target': 'standard_fashion_gvendi14.3_sub4',   'name': 'wide_to_std_gvendi_fashion_14.3_sub4',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi13.3_sub5',   'target': 'standard_fashion_gvendi13.3_sub5',   'name': 'wide_to_std_gvendi_fashion_13.3_sub5',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi11.1_sub6',   'target': 'standard_fashion_gvendi11.1_sub6',   'name': 'wide_to_std_gvendi_fashion_11.1_sub6',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi10.9_sub7',   'target': 'standard_fashion_gvendi10.9_sub7',   'name': 'wide_to_std_gvendi_fashion_10.9_sub7',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi13.9_sub8',   'target': 'standard_fashion_gvendi13.9_sub8',   'name': 'wide_to_std_gvendi_fashion_13.9_sub8',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
          {'source': 'wide_fashion_gvendi12.1_sub9',   'target': 'standard_fashion_gvendi12.1_sub9',   'name': 'wide_to_std_gvendi_fashion_12.1_sub9',   'N': 20, 'ranks': [None, None, None, None,None, None, None, None]},
      ],                                                                                                                                                                                                                                               
  }   
_SUBSETS = [
...
_INTERP_SUBSETS = [
    'gvendi12.1_sub0', 'gvendi13.6_sub1', 'gvendi14.5_sub2', 'gvendi14.0_sub3',
    'gvendi14.3_sub4', 'gvendi13.3_sub5', 'gvendi11.1_sub6', 'gvendi10.9_sub7',
    'gvendi13.9_sub8', 'gvendi12.1_sub9',
]

COMPUTE_FMAPS = [
      (f'wide_fashion_interp_{tag}', f'standard_fashion_interp_{tag}', f'fmap_wide_to_std_interp_{tag}', 30)
      for tag in _INTERP_SUBSETS
  ]+[
      (f'wide_fashion_interp_{tag}', f'standard_fashion_interp_{tag}', f'fmap_wide_to_std_interp_{tag}', 29)
      for tag in _INTERP_SUBSETS
  ]+[
      (f'wide_fashion_interp_{tag}', f'standard_fashion_interp_{tag}', f'fmap_wide_to_std_interp_{tag}', 28)
      for tag in _INTERP_SUBSETS
  ]
                                                                                                                                                                                                                                        
TRANSPORT_ORTHO = [
    (f'procrustes_matrices_{entry["name"]}_{entry["N"]}', entry['name'])
    for entry in COMPUTE_ORTHO_MAP['to_compute']
]
